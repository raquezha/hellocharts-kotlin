 ...
 * It scroll and zoom only preview area, not all preview chart data.
 */
open class PreviewChartTouchHandler(context: Context, chart: Chart) : ChartTouchHandler(context, chart) {
    init {
    ...
    protected inner class PreviewChartGestureListener : ChartGestureListener() {
