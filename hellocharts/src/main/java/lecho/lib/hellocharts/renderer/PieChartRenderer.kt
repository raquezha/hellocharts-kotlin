    ...
    private void drawCenterCircle(Canvas canvas) {
        ...
        if (!TextUtils.isEmpty(data.getCenterText1())) {
            ...
            if (!TextUtils.isEmpty(data.getCenterText2())) {
                ...
                canvas.drawText(data.getCenterText1(), centerX, centerY + text1Height / 4f, centerCircleText1Paint);
            }
        }
    }

    /**
     * Draw all slices for this PieChart, if mode == {@link #MODE_HIGHLIGHT}
