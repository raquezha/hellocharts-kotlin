...
import net.raquezha.lecho.hellocharts.formatter.PieChartValueFormatter;
import net.raquezha.lecho.hellocharts.formatter.SimplePieChartValueFormatter;
...
public class PieChartData extends AbstractChartData {
     ...
     * isValueSelectionEnabled set to true {@link net.raquezha.lecho.hellocharts.view.Chart#setValueSelectionEnabled(boolean)}.
     */
     ...
     * should also change chart fill ration using {@link net.raquezha.lecho.hellocharts.view.PieChartView#setCircleFillRatio(float)}. This flag is used only
